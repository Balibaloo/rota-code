# The road to done: the diary, archived 2026-09-13

Tracks A to D, the questions for the seat, the four answers of 2026-08-30,
the S0 story and the levels, as written between 2026-08-28 and 2026-09-13.
Evidence, not a document to read: the live account is `rota/MAP.md` and
`rota/COMPLETION.md`. Mechanism claims in here were audited against the
code in `plans/lost-work-audit.md`; the one found false (`S0-hello-world`
as a register case) is marked there.
