...
1. Publish the cassette database as the first release. The repository
   ...
   ```
   gh release create cassettes-20260914 --repo Balibaloo/rota-code --title cassettes-20260914 --latest --notes "cassettes 2026-09-14: 17872 cassettes, 136415 case runs" D:\repos\rota\.rota\release\cassettes.db.gz D:\repos\rota\.rota\release\cassettes.json
   ```
