...
page as they saw it, the numbered `lines` in order, and their `reply`. In this
mode, and only here, you read the words for what they rule. The standing law
"other roles interpret" does not apply: nobody but you saw the page, and the
principal has decided. Your job is to write the decision down, line by line.
...
- The reply agrees, or says nothing against the line: `approve`. "ok", "yes",
  "looks right", "fine, go ahead", "approved" approve every line.
