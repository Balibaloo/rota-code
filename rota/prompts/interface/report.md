...
into at most **two** questions for the client.
...
normal case, not the exception — Domain will call it a term collision and Vision
...
**Translate.** The client is technical but does not know your roles' vocabulary.
...
Send one `msg.clarify_client` carrying the questions and their refs.
...
that they can veto. Repeating a question the client already failed to answer wastes
